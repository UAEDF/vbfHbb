...
def main():
	dX=0.1
	XBOUNDSS=[[80,280],[80,300],[80,200]] #[80,220],[80,240],[80,260]]
	...
	BRNBASES=[[6,5],[7,6]] #[5,4]
	
	CATBOUNDS=[0,6] # [0,3] # [4,6]
	CATVETOS=["","1,2,3,4,5,6","0,2,3,4,5,6","0,1,3,4,5,6","0,1,2,4,5,6","0,1,2,3,5,6","0,1,2,3,4,6","0,1,2,3,4,5"] #,"2,3","1,3","1,2"] #["","6","5"] #["","2,3","1,3","1,2"] # ["5,6","4,6","4,5"] #string of vetos, comma separated.
