...
fsave = TFile.Open("puReweight_SetA.root","recreate")
...
tq1.SetWeight(19784./4.837581)
tq2.SetWeight(19784./98.05)
tq3.SetWeight(19784./3631.531688)
tq4.SetWeight(19784./28167.827502)
...
for t in ts:
    t.SetBranchStatus("*",0)
    for v in ["jetPt","mqq","dEtaqq","rho","jetBtag","b1","b2","triggerResult","puWt","nvtx","npu"]:
...
for t in td:
    ...
    for i,iev in enumerate(t):
        ...
        if iev.jetBtag[iev.b1[0]]>0.244 and iev.jetBtag[iev.b2[0]]>0.244 and iev.jetPt[3]>40.0 and iev.jetPt[2]>50.0 and iev.jetPt[1]>70.0 and iev.jetPt[0]>80.0 and iev.dEtaqq[1]>2.5 and iev.mqq[1]>250:
            if iev.triggerResult[0]==TRUE0 or iev.triggerResult[1]==TRUE0:
                for var in ["rho","npu","nvtx","jetPt[0]"]:
                    h4[var].Fill(eval("iev.%s"%var),nn)
                if iev.triggerResult[5]==TRUE0 or iev.triggerResult[7]==TRUE0:
                    for var in ["rho","npu","nvtx","jetPt[0]"]:
