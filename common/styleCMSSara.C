...
// Margins:
  ...
  tdrStyle->SetPadLeftMargin(0.19); //0.16
  tdrStyle->SetPadRightMargin(0.03); //0.02

// For the Global title:
  tdrStyle->SetOptTitle(0);    // 0=No Title
  tdrStyle->SetTitleFont(42);
  tdrStyle->SetTitleColor(kViolet+3);
  tdrStyle->SetTitleTextColor(kViolet+3);
...
// For the axis titles:
  tdrStyle->SetTitleColor(kViolet+3, "XYZ");
  tdrStyle->SetTitleFont(62, "XYZ");
  tdrStyle->SetTitleSize(0.05, "XYZ");
  // tdrStyle->SetTitleXSize(Float_t size = 0.02); // Another way to set the size?
  // tdrStyle->SetTitleYSize(Float_t size = 0.02);
  tdrStyle->SetTitleXOffset(1.1);
  tdrStyle->SetTitleYOffset(1.9); //1.25
  // tdrStyle->SetTitleOffset(1.1, "Y"); // Another way to set the Offset

// For the axis labels:
  tdrStyle->SetLabelColor(kViolet+3, "XYZ");
