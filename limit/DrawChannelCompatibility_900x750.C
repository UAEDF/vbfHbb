...
//	ExtraPaves[iChann] = new TPaveText(-27.5,points->GetYaxis()->GetBinCenter(iChann),-15,points->GetYaxis()->GetBinCenter(iChann) + points->GetYaxis()->GetBinWidth(iChann)/2.);
		...
		ExtraPaves[iChann] = new TPaveText(0.15,gStyle->GetPadBottomMargin()+space/7.*(iChann+0.5),0.35,gStyle->GetPadBottomMargin() + space/7.*(iChann+0.9),"NDC");
  ...
  frame->GetYaxis()->SetLabelOffset(frame->GetYaxis()->GetLabelOffset()*0.95);
  frame->Draw(); 
  //gStyle->SetOptStat(0);
  ...
  TPaveText *pave = new TPaveText(0.63,0.82,0.92,1.-gStyle->GetPadTopMargin()-0.03,"NDC");
  ...
  ln0->Draw("same");
    ...
    TPaveText *paveCMS = new TPaveText(gStyle->GetPadLeftMargin()+0.02,1.-gStyle->GetPadTopMargin(),gStyle->GetPadLeftMargin()+0.15,1.,"NDC");
	 ...
	 paveCMS->Draw();
	 gPad->Update();
    TPaveText *paveCMS2 = new TPaveText(gStyle->GetPadLeftMargin()+0.105,1.-gStyle->GetPadTopMargin(),gStyle->GetPadLeftMargin()+0.20,1.-0.005,"NDC");
	 paveCMS2->SetTextFont(52);
	 paveCMS2->SetTextSize(gStyle->GetPadTopMargin()*2.5/4.);
