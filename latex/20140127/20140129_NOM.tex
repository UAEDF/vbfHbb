...
\begin{itemize}
 \item mqq[1] $>$ 250
 \item dEtaqq[1] $>$ 2.5
 \item jetPt[i] $>$ 80, 70, 50, 40 
 \item triggerResult[0] || [1] == 1\vskip 2em
\end{itemize}
...
%   print r"\includegraphics[width=0.28\textwidth]{./blank.pdf}"
%   if jj%3==2: print r"\newline"
%   else: print r"\hfill"
% \end{python}
% 
...
plots = glob.glob("%s/*/*AV80*.png"%directory) 
...
for jj in range(ii,4):
  print r"\includegraphics[width=0.48\textwidth]{./blank.pdf}"
  if jj%2==2: print r"\newline"
  else: print r"\hfill"
\end{python} 
\end{frame}
...
%   print r"\includegraphics[width=0.30\textwidth]{./blankdatamc.pdf}"
%   if jj%3==2: print r"\newline"
%   else: print r"\hfill"
% \end{python}
% 
